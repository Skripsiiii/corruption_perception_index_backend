                ...
                <div id="form-container" class="w-full md:w-2/3 mx-auto rounded-md drop-shadow-md bg-white py-4 px-8 lg:px-16">
                    <form action="" method="post">
                        ...
                        <div class="w-full mt-6">
                            <input disabled class="rounded-md border-none w-full bg-bgSecondary py-2 px-4" type="text" name="email" id="" placeholder="Email"=>
                        </div>
                        <div class="w-full mt-6">
                            <input class="rounded-md border-none w-full bg-bgSecondary py-2 px-4" type="text" name="password" id="" placeholder="password"=>
                        </div>
                        <div class="w-full mt-6">
                            <input class="rounded-md border-none w-full bg-bgSecondary py-2 px-4" type="text" name="password_confirmation" id="" placeholder="Confirm Password"=>
                        </div>
                        <div class="w-full mt-6">
                            <input class="rounded-md border-none w-full bg-bgFourth hover:bg-bgThird transition duration-500 ease-in-out cursor-pointer text-white py-2 px-4" type="submit" name="" id="" value="Reset Password">
                        </div>
                    </form>
                </div>
            </div>
